			...
			<div class="row">
				<div class="col-md-12">
					<div class="col-md-3 col-md-offset-6 margin-top">
						<a class="btn btn-danger btn-borrar" data-toggle="modal" data-target="#delete-modal" data-user="<?=$video->userid?>" data-video="<?=$video->id?>" data-title="<?=$video->title?>"><i class="glyphicon glyphicon-trash"></i> Borra este video</a>
					</div>
